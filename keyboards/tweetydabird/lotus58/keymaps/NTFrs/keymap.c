...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        LCTL_TLSFT_T(KC_LEFT), KC_Z, KC_X,    KC_C,    KC_V,  KC_B,        KC_DOWN,          KC_UP,  KC_N,    KC_M, KC_COMM, KC_DOT, KC_SLSH, RSFT_T(KC_RGHT),
                                     KC_LGUI, KC_LALT, TT(2), LSFT_T(KC_SPC), RCTL_T(KC_ENT), TT(1), KC_RALT, KC_BSPC
    ),
    ...
    [1] = LAYOUT(
        ...
        KC_LCTL, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_PGDN,        KC_PGUP, KC_DLR,  XXXXXXX, XXXXXXX, XXXXXXX, KC_BSLS, KC_RCTL,
    ...
    [2] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______,        _______, s  KC_1 , KC_2 ,   KC_3 , _______, _______, _______,
