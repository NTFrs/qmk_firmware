...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        LCTL_T(KC_LEFT), KC_Z, KC_X,    KC_C,    KC_V,  KC_B,        KC_DOWN,           KC_UP,  KC_N,    KC_M, KC_COMM, KC_DOT, KC_SLSH, RSFT_T(KC_RGHT),
    ...
    [1] = LAYOUT(
        ...
        KC_LCTL, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_PGDN,        KC_PGUP, KC_DLR,  XXXXXXX, XXXXXXX, XXXXXXX, KC_BSLS, KC_LSFT,
